...
import { AreaNameOfTemplate, TableItem } from "../components/Table/types"

export default function GoldenRectangle() {
  const template = ["a b b b b", "a e f f c", "a e i g c", "a e h g c", "a d d d c"] as const
  const tableItems: TableItem<AreaNameOfTemplate<typeof template>>[] = [
    {
      area: "a",
      height: 200,
      width: 200,
  ...
  return <Table debug={true} template={template} items={tableItems} />
}
